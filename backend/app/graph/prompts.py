DEFAULT_SYSTEM_PROMPT = """你是一个文化遗产领域的知识图谱构建专家。请从以下文本中抽取实体和关系。
...
QA_SYSTEM_PROMPT_TEMPLATE = """你是一个文化遗产知识图谱问答助手。
请仅基于给定的知识图谱上下文回答问题，不要编造上下文中不存在的事实。
如果上下文信息不足，请明确回答“根据当前图谱数据，无法确定”并说明缺失点。

{custom_prompt}
"""


QA_USER_PROMPT_TEMPLATE = """【知识图谱上下文】
{context}
